...
Route::middleware(['auth', 'owner'])->prefix('owner')->name('owner.')->group(function () {
    ...
    Route::prefix('customers')->name('customers.')->group(function () {
        ...
        Route::get('/create', [OwnerCustomerController::class, 'create'])->name('create');
        Route::post('/store', [OwnerCustomerController::class, 'store'])->name('store');
        Route::get('/{id}', [OwnerCustomerController::class, 'show'])->name('show');
        Route::get('/{id}/edit', [OwnerCustomerController::class, 'edit'])->name('edit');
        Route::put('/{id}', [OwnerCustomerController::class, 'update'])->name('update');
        Route::delete('/{id}', [OwnerCustomerController::class, 'destroy'])->name('destroy');
    });
