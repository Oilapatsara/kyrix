...
@section('title', 'KYRIX | ร้านเช่าชุดออก ชุดสายฝอ และชุดสายหวาน')
    ...
    <section class="hero-section">
        <div class="hero-container">
            <div>
                ...
                <p class="hero-desc">
                    ค้นพบชุดออกงาน ชุดสายฝอ สายหวาน ที่มีคุณภาพสูง ออกแบบและตัดเย็บอย่างประณีต ระบบจองออนไลน์ที่ง่ายดาย
                    รวดเร็ว พร้อมบริการจัดส่งและปรับแก้ทรงฟรี
                </p>
            ...
            <div class="hero-gallery">
                <div class="hero-img-card tall">
                    <img src="https://images.unsplash.com/photo-1566174053879-31528523f8ae?w=800&auto=format&fit=crop&q=80"
                        alt="ชุดราตรีหรู">
                </div>
                <div class="hero-img-card">
                    <img src="https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=800&auto=format&fit=crop&q=80"
                        alt="ชุดราตรีปักเลื่อม">
                </div>
                ...
                <div class="product-card">
                    ...
                    <div class="product-body">
                        ...
                        <div class="product-meta">
                            ...
                            <span title="{{ $product->colors_text }}"><i class="fa-solid fa-palette"></i>
                                {{ Str::limit($product->colors_text, 30) }}</span>
                        </div>
                        <div class="product-footer">
                            <div class="price-wrap">
                                <span class="price-value">฿{{ number_format($product->rental_price) }} <small
                                        style="font-size: 12px; font-weight: normal; color: #888;">/ วัน</small></span>
    ...
    <section class="section-wrap">
        <div class="promo-banner">
            <div>
                ...
                <p class="promo-desc">
                    เช่าชุดออกงาน ชุดสายฝอ สายหวาน เพียงเลือกเช่าครบ 3 รายการขึ้นไป หรือมียอดค่าเช่าครบ 2,000 บาท
                    ระบบจะคำนวณส่วนลด 20% ให้อัตโนมัติทันทีในตะกร้าสินค้า!
                </p>
                    ...
                    <div class="review-card">
                        ...
                        <div class="review-author">
                            ...
                            <div>
                                ...
                                <div class="author-dress">
                                    {{ Str::limit($review->product->product_name ?? 'ชุดเช่า', 22) }}</div>
                            </div>
                        </div>
                    </div>
                @endforeach
