...
@section('content')
    ...
    <div class="kyrix-admin-container">
        ...
        <div class="admin-header">
            <div class="admin-heading">
                ...
                <h1>เพิ่มชุดใหม่</h1>
                <p>กรอกรายละเอียดข้อมูลชุด ราคา สต็อก ไซซ์ สี สัดส่วน และเพิ่ม URL รูปภาพเพื่อเพิ่มลงในคลัง</p>
            </div>
        </div>
        ...
        <div class="content-card">
            ...
            <form id="createDressForm" action="{{ route('owner.dresses.store') }}" method="POST">
                @csrf
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="product_code" value="{{ old('product_code', $defaultCode ?? '') }}"
                            required class="form-control" placeholder="เช่น KY-DRS-0001">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="product_name" value="{{ old('product_name') }}" required
                        class="form-control" placeholder="ระบุชื่อชุด เช่น ชุดราตรีสั้นสีทองหรูหรา">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="rental_price" value="{{ old('rental_price') }}" required
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="deposit" value="{{ old('deposit', 100.0) }}" required
                            class="form-control" placeholder="100.00">

                        <small style="color: var(--muted); font-size: 11px;">
                            กำหนดค่ามัดจำมาตรฐาน 100 บาท (คืนให้ลูกค้าเมื่อคืนชุดและไม่มีความเสียหาย)
                        </small>
                ...
                <div class="block-title">
                    ...
                    <small>ลูกค้าจะเห็นเป็นตัวเลือกในหน้ารายละเอียดชุด</small>
                </div>
                        ...
                        @foreach ($sizeOptions as $size)
                            <label class="chip">
                                ...
                                <input type="checkbox" name="sizes[]" value="{{ $size }}"
                                    {{ in_array($size, (array) $selectedSize) ? 'checked' : '' }}>
                    ...
                    <div id="colorList">
                        ...
                        @foreach ((array) $oldColorNames as $i => $colorName)
                            <div class="color-row">
                                ...
                                <input type="text" name="color_names[]" class="form-control" value="{{ $colorName }}"
                                    placeholder="ชื่อสี เช่น แดงเบอร์กันดี">
                ...
                <div class="block-title">
                    ...
                    ตารางสัดส่วนชุด
                    <small>หน่วยเป็นนิ้ว ยกเว้นความยาวเป็นเซนติเมตร</small>
                </div>
                    ...
                    <div class="measure-box">
                        ...
                        <div class="measure-grid">
                            ...
                            <div class="measure-item">
                                ...
                                <input type="text" name="bust" value="{{ old('bust') }}" class="form-control"
                                    placeholder="32-34 นิ้ว">
                            </div>

                            <div class="measure-item">
                                <label>รอบเอว (Waist)</label>

                                <input type="text" name="waist" value="{{ old('waist') }}" class="form-control"
                                    placeholder="25-27 นิ้ว">
                            </div>

                            <div class="measure-item">
                                <label>สะโพก (Hips)</label>

                                <input type="text" name="hips" value="{{ old('hips') }}" class="form-control"
                                    placeholder="35-37 นิ้ว">
                            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="image-url-box">
                        ...
                        <input type="url" name="image_url" id="image_url" value="{{ old('image_url') }}"
                            class="form-control" placeholder="https://example.com/dress.jpg">

                        <small class="url-help">
                            ใส่ลิงก์รูปภาพที่อยู่บนอินเทอร์เน็ต เช่น
                        ...
                        <div id="previewBox" class="preview-box">
                            <div style="margin-bottom: 8px; color: var(--maroon-900); font-size: 12px; font-weight: 700;">
                                ตัวอย่างรูปภาพ
                            </div>

                            <img id="previewImage" src="" alt="ตัวอย่างรูปภาพชุด">
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" rows="4" class="form-control"
                        placeholder="ระบุรายละเอียดเนื้อผ้า ไซส์ หรือเงื่อนไขการเช่า...">{{ old('description') }}</textarea>
    ...
    <script>
        ...
        // ลบแถวสี โดยเหลืออย่างน้อย 1 แถว
        ...
        // ตรวจ URL รูปเมื่อกรอก
        document
            .getElementById('image_url')
            .addEventListener('input', previewImageFromUrl);

        // แสดงตัวอย่างเมื่อเปิดหน้า
        ...
        function confirmCreate() {
            ...
            const sizes = form.querySelectorAll(
                'input[name="sizes[]"]:checked'
            ).length;

            // ตรวจฟิลด์บังคับของเบราว์เซอร์ก่อน
            if (!form.reportValidity()) {
                return;
            }

            // ตรวจว่ามีการเลือกไซซ์อย่างน้อย 1 รายการ
            if (sizes === 0) {
                Swal.fire({
