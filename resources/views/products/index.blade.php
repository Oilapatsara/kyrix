            ...
            <div class="filter-group">
                <div class="filter-title">
                    ...
                    @if(request('category_id'))
                        <a
                            href="{{ route('products.index', request()->except('category_id')) }}"
                ...
                <div class="filter-options">
                    ...
                    <label class="filter-checkbox">
                        ...
                        <span>
                            <i
                                ...
                                style="color: #16a34a; font-size: 8px;"
                            ></i>
                            ว่างพร้อมเช่า
                        </span>
                    </label>
                    ...
                    <label class="filter-checkbox">
                        ...
                        <span>
                            <i
                                class="fa-solid fa-circle"
                                style="color: #b45309; font-size: 8px;"
                            ></i>
                            อยู่ระหว่างเช่า
                        </span>
                    </label>
                    ...
                    <label class="filter-checkbox">
                        <input
                            ...
                            name="status"
                            value="maintenance"
                            {{ request('status') == 'maintenance' ? 'checked' : '' }}
                            onchange="this.form.submit()"
                        >
                        <span>
                            <i
                                class="fa-solid fa-circle"
                                style="color: #dc2626; font-size: 8px;"
                            ></i>
                            ซ่อม / ปรับปรุง
                        </span>
                    </label>
        ...
        <div class="catalog-toolbar">
            ...
            <div>
                ...
                <select
                    ...
                    class="sort-select"
                    onchange="
                        document.getElementById('filterForm').elements['sort'].value = this.value;
        ...
        <div class="catalog-grid">
            ...
            @forelse($products as $product)
                ...
                @php
                     ...
                     * รูปสำรอง
                     */
                    $fallbackImage = 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&w=800&q=80';

                    /*
                     * ถ้าไม่มี URL ใช้รูปสำรอง
                     */
                ...
                <div class="product-card">
                    ...
                    >
                        ...
                        <div class="product-image-fallback">
                            ...
                            <span>ไม่สามารถโหลดรูปภาพสินค้าได้</span>
                        </div>
