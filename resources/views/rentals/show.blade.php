                ...
                <div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <strong
                                style="color: var(--primary);">{{ date('d/m/Y', strtotime($rental->start_date)) }}</strong>
                        </div>
                        <div>
                            <span
                                style="font-size: 12px; color: var(--text-muted); display: block;">วันกำหนดส่งคืนชุด</span>
                    ...
                    <div class="breakdown-grid">
                            ...
                            <div class="info-card">
                                ...
                                @if ($rental->return_tracking_no)
                                    <div style="margin-top: 4px; color: #166534; font-weight: 700;">
                                        <i class="fa-solid fa-box"></i> เลขพัสดุส่งคืนชุด:
                        ...
                        <div
                            ...
                            <div>
                                <span
                                    style="font-size: 12px; color: var(--text-muted); display: block;">วันที่ทำรายการ</span>
                                <strong>{{ $rental->rental_date ? date('d/m/Y', strtotime($rental->rental_date)) : $rental->created_at->format('d/m/Y') }}</strong>
                            </div>
                            <div>
                                <span
                                    style="font-size: 12px; color: var(--text-muted); display: block;">วันเริ่มรับชุด</span>
                                <strong
                                    style="color: var(--primary);">{{ date('d/m/Y', strtotime($rental->start_date)) }}</strong>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div
                                    style="background: var(--gold-light); padding: 12px; border-radius: 8px; font-size: 12.5px; color: #855d14; margin-top: 14px; line-height: 1.5; border: 1px solid #f3e5c8;">
                                    <i class="fa-solid fa-shield"></i> เงินมัดจำประกันชุด
                                    <strong>฿{{ number_format($rental->deposit_amount) }}</strong>
                                    จะได้รับคืนทันทีในวันที่ส่งคืนชุด หากตรวจสภาพแล้วชุดไม่มีการเสียหาย
                                    (กรณีชุดมีความเสียหาย ทางร้านขอสงวนสิทธิ์ไม่คืนเงินมัดจำ)
                            ...
                            <div class="breakdown-grid">
                                ...
                                <div style="display: flex; flex-direction: column; gap: 16px;">
                                    <div class="info-card">
                                        ...
                                        @if ($rental->tracking_number)
                                            <div style="margin-top: 8px; color: var(--primary); font-weight: 700;">
                                                <i class="fa-solid fa-barcode"></i> เลขพัสดุจัดส่ง:
                                    ...
                                    <div class="info-card">
                                        ...
                                        @if ($rental->payments->count() > 0)
                                            @foreach ($rental->payments as $payment)
                                                <div
                                                    ...
                                                    <div>
                                                        <span>ยอด:
                                                            <strong>฿{{ number_format($payment->payment_amount) }}</strong></span>
                                                        <span
                                                        ...
                                                        <div style="font-size: 11px;">
                                                            ...
                                                            @if ($payment->status === 'approved')
                                                                <span
                                                                    style="color: #166534; font-weight: 700;">ตรวจสอบอนุมัติแล้ว</span>
                                                            @else
                                                                <span
                                                                    style="color: #b45309; font-weight: 700;">รอเจ้าหน้าที่ตรวจสลิป</span>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    @if ($payment->slip_url)
                                                        <a href="{{ $payment->slip_url }}" target="_blank">
                                                            <img src="{{ $payment->slip_url }}" class="slip-img-card"
                                                                alt="สลิป">
                                                        </a>
                                                    @endif
                                                </div>
                                        ...
                                        @else
                                            <p style="color: var(--text-muted); margin: 0;">
                                                ยังไม่มีข้อมูลการชำระเงินหรือแนบสลิป</p>
                                        @endif
                                    </div>
                                </div>
                            ...
                            @if ($rental->status === 'pending_payment')
                                <div id="slipSection"
                                    ...
                                    <h3
                                        style="font-size: 18px; font-weight: 800; color: var(--primary); margin-bottom: 8px;">
                            ...
                            @if (in_array($rental->status, ['renting', 'ready_pickup', 'confirmed']))
                                <div id="returnSection"
                                    ...
                                    <h3
                                        style="font-size: 18px; font-weight: 800; color: var(--text-main); margin-bottom: 8px;">
                                        <i class="fa-solid fa-arrow-rotate-left" style="color: var(--primary);"></i>
                                        แจ้งส่งคืนชุด (Return
                                        Request)
                                    </h3>
                                    <p style="font-size: 13px; color: var(--text-muted); margin-bottom: 18px;">
                                    ...
                                    <form action="{{ route('rentals.request-return', $rental->rental_id) }}"
                                        method="POST">
                                        @csrf
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <select name="return_method" class="input-field" style="margin-top: 0;"
                                                    required>
                                                    <option value="นำมาคืนที่หน้าร้านทองหล่อ">นำมาคืนที่หน้าร้าน KYRIX
                                                        (โคราช)</option>
                                                    <option value="ส่งพัสดุ (EMS / Flash / Kerry)">ส่งพัสดุไปรษณีย์ (EMS /
                                                        Flash / Kerry)
                                                    </option>
                                                    <option value="ส่งผ่านแมสเซนเจอร์ (Grab / Lineman)">ส่งผ่านแมสเซนเจอร์
                                                        (Grab / Lineman)
                                                    </option>
                                                </select>
                                            </div>
                        ...
                        @if (in_array($rental->status, ['returned', 'completed']) || $rental->condition_status)
                            <div
                                style="margin-top: 30px; padding: 22px; border-radius: var(--radius-md); border: 2px solid {{ $rental->condition_status === 'damaged' ? '#fca5a5' : '#86efac' }}; background: {{ $rental->condition_status === 'damaged' ? '#fff5f5' : '#f0fdf4' }};">
                                <div style="display: flex; align-items: flex-start; gap: 14px;">
                                    <div
                                        style="font-size: 28px; color: {{ $rental->condition_status === 'damaged' ? '#dc2626' : '#16a34a' }};">
                                    ...
                                    <div style="flex: 1;">
                                        <h4
                                            style="font-size: 16px; font-weight: 800; color: {{ $rental->condition_status === 'damaged' ? '#991b1b' : '#166534' }}; margin-bottom: 6px;">
                                            @if ($rental->condition_status === 'damaged')
                                        ...
                                        <div
                                            style="font-size: 13.5px; color: #374151; margin-bottom: 10px; line-height: 1.6;">
                                            @if ($rental->condition_status === 'damaged')
                                                ทางร้านได้ทำการตรวจสอบสภาพชุดแล้ว <strong>ตรวจพบความเสียหาย</strong>
                                                จึงขอสงวนสิทธิ์ไม่คืนเงินมัดจำประกันชุดจำนวน
                                                <strong>฿{{ number_format($rental->deposit_amount ?: 100, 2) }}</strong>
                                                ให้แก่ท่านตามเงื่อนไขของทางร้าน
                                                @if ($rental->damage_note)
                                                    <div
                                                        style="margin-top: 8px; padding: 10px 14px; background: #fee2e2; border-radius: 6px; color: #991b1b; font-size: 13px;">
                                                        <strong>สาเหตุ/รายละเอียดความเสียหาย:</strong>
                                                        {{ $rental->damage_note }}
                                                    </div>
                                                @endif
                                            @else
                                                ทางร้านได้ทำการตรวจสอบสภาพชุดแล้ว <strong>ชุดอยู่ในสภาพสมบูรณ์
                                                    ไม่พบความเสียหายใดๆ</strong> และได้ดำเนินการคืนเงินมัดจำประกันชุดจำนวน
                                                <strong>฿{{ number_format($rental->deposit_refund_amount ?: ($rental->deposit_amount ?: 100), 2) }}</strong>
                                                ให้แก่ท่านเรียบร้อยแล้ว
                                            @endif
                                        </div>

                                        @if ($rental->inspected_at)
                                            <div style="font-size: 12px; color: #6b7280; margin-bottom: 10px;">
                                                <i class="fa-regular fa-clock"></i> ตรวจรับและบันทึกข้อมูลเมื่อ:
                                                {{ $rental->inspected_at->format('d/m/Y H:i') }} น.
                                            </div>
                                        @endif
                                        ...
                                        @if ($rental->refund_slip || $rental->damage_image)
                                            <div style="display: flex; gap: 16px; flex-wrap: wrap; margin-top: 10px;">
                                                @if ($rental->refund_slip)
                                                    <div>
                                                        <div
                                                            ...
                                                            หลักฐานสลิปโอนคืนเงินมัดจำ:
                                                        </div>
                                                        <a href="{{ $rental->refund_slip_url }}" target="_blank">
                                                            <img src="{{ $rental->refund_slip_url }}"
                                                                style="max-width: 140px; max-height: 180px; border-radius: 8px; border: 1px solid #86efac; box-shadow: 0 2px 6px rgba(0,0,0,0.08);"
                                                                alt="สลิปโอนคืนมัดจำ">
                                                        </a>
                                                    </div>
                                                @endif
                                                @if ($rental->damage_image)
                                                    <div>
                                                        <div
                                                            style="font-size: 12px; font-weight: 700; color: #991b1b; margin-bottom: 4px;">
                                                            <i class="fa-solid fa-camera"></i> ภาพถ่ายหลักฐานความเสียหาย:
                                                        </div>
                                                        <a href="{{ $rental->damage_image_url }}" target="_blank">
                                                            <img src="{{ $rental->damage_image_url }}"
                                                                style="max-width: 140px; max-height: 180px; border-radius: 8px; border: 1px solid #fca5a5; box-shadow: 0 2px 6px rgba(0,0,0,0.08);"
                                                                alt="รูปหลักฐานความเสียหาย">
                                                        </a>
                                                    </div>
                                                @endif
                                            </div>
                        ...
                        @if ($rental->status === 'pending_payment')
                            <div id="slipSection"
                                ...
                                <p style="font-size: 13px; color: var(--text-muted); margin-bottom: 18px;">
                                    โอนเงินเข้าบัญชี กสิกรไทย 123-4-56789-0 (บจก. ไคริกซ์ เดรส เรนทอล) ยอดรวม
                                    ฿{{ number_format($rental->grand_total) }} แล้วแนบสลิปด้านล่าง
                                </p>
                        ...
                        @elseif($rental->status === 'pending_return')
                            <div
                                style="margin-top: 36px; padding: 22px; border: 1px solid #f3d28c; border-radius: var(--radius-md); background: #fff8e8; color: #8a5a0a;">
