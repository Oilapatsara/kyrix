    ...
    <div class="checkout-wrap">
        ...
        <div class="checkout-header">
            <h1>
                ...
                <span>
                    ชำระเงิน & ยืนยันการเช่าชุด
                </span>
            </h1>

            <p style="color: var(--text-muted); font-size: 14px;">
                กรุณาตรวจสอบข้อมูลการรับชุดและทำรายการชำระเงินเพื่อยืนยันการจอง
            </p>
        </div>
        ...
        <form action="{{ route('checkout.process') }}" method="POST" enctype="multipart/form-data" id="checkoutForm">
            ...
            <div class="checkout-grid">
                ...
                <div>
                    ...
                    <!-- เลือกวันรับ / วันคืนชุด -->
                    <div class="form-card">
                        <h3 class="card-title">
                            <i class="fa-solid fa-calendar-days"></i>

                            <span>
                                กำหนดวันรับและวันคืนชุด
                            </span>
                        </h3>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <input type="date" name="start_date" class="input-field" value="{{ old('start_date') }}"
                    ...
                    <div class="form-card">
                        ...
                        <div style="margin-bottom: 16px;">
                            ...
                            <label
                                style="
                                    ...
                                    font-weight: 600;
                                ">
                                เบอร์โทรศัพท์สำหรับติดต่อรับชุด *
                            </label>

                            <input type="text" name="recipient_phone" class="input-field"
                                value="{{ old('recipient_phone', $customer->phone) }}" placeholder="เช่น 089-123-4567"
                                required>
                        </div>
                        ...
                        <div id="addressBox"
                            ...
                            <label
                                style="
                                    ...
                                    font-weight: 600;
                                ">
                                ที่อยู่สำหรับจัดส่งชุด *
                            </label>

                            <textarea name="delivery_address" class="input-field" rows="3"
                                placeholder="บ้านเลขที่, ถนน, แขวง/ตำบล, เขต/อำเภอ, จังหวัด, รหัสไปรษณีย์">{{ old('delivery_address', $customer->address) }}</textarea>
                        </div>
                        ...
                        <div style="margin-top: 10px;">
                            ...
                            <input type="text" name="note" class="input-field"
                                placeholder="เช่น ขอรับชุดช่วงเช้า, ปรับความยาวกระโปรง ฯลฯ">
                        </div>
                        ...
                        <div>
                            ...
                            <p
                                style="
                                    ...
                                    margin-bottom: 12px;
                                ">
                                เมื่อโอนเงินแล้ว กรุณาแนบรูปภาพสลิปเพื่อให้เจ้าหน้าที่อนุมัติและเตรียมชุดทันที
                                (สามารถแนบภายหลังได้ในหน้า การจองของฉัน)
                            </p>
                            ...
                            <div class="slip-upload-box" onclick="document.getElementById('slipInput').click();">
                                ...
                                <input type="file" name="slip_image" id="slipInput" accept="image/*"
                                    style="display: none;" onchange="previewSlip(event)">
                ...
                <div class="order-summary-card">
                    ...
                    <div
                        ...
                        @foreach ($cart as $item)
                            <div
                                ...
                                <img src="{{ $item['image_url'] }}" class="checkout-item-thumb"
                    ...
                    <div
                        ...
                        @if (!empty($discountAmount) && $discountAmount > 0)
                            <div
                                ...
                                <span
                                    ...
                                    ">
                                    ส่วนลด 20%
                                    สำหรับการเช่าครบ 3 รายการ
                                    หรือยอดเช่าครบ 2,000 บาท
                                </span>
                        ...
                        <div
                            ...
                            จะได้รับคืนทันทีในวันที่คืนชุด
    ...
    @push('scripts')
        <script>
            function toggleDelivery(type, labelElem) {
                ...
                document
                    .querySelectorAll('.delivery-card-label')
