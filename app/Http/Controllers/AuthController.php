...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        // ตรวจอีเมลซ้ำทั้งลูกค้าและเจ้าของร้าน
        if(Customer::where('email',$data['email'])->exists() || User::where('email',$data['email'])->exists()){
            return back()->withErrors([
        ...
        try{
            ...
            // Login ลูกค้าผ่าน Session ของ Customer
            $request->session()->regenerate();
